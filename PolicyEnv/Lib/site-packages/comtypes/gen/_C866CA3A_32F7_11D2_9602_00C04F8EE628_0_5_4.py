...
__all__ = [
    'SPSEMANTICERRORINFO', 'DISPID_SABufferNotifySize',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVSInputSentencePosition',
    'SPAR_Unknown', 'SAFT32kHz8BitStereo', 'ISpNotifySource', 'SVP_1',
    'SPINTERFERENCE_NOSIGNAL', 'ISpDataKey', 'DISPID_SOTRemove',
    'SPVISEMES', 'DISPID_SPAStartElementInResult', 'SVEPrivate',
    'DISPID_SpeechCustomStream', 'SPFILEMODE', 'SECNormalConfidence',
    'ISpeechDataKey', 'DISPID_SRAudioInput', 'SPFM_CREATE',
    'DISPID_SVESentenceBoundary', 'SASClosed',
    'DISPID_SPRules_NewEnum', 'DISPID_SRRAudioFormat',
    'DISPID_SLPPhoneIds', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRCRecognizer', 'SVSFPurgeBeforeSpeak', 'SLOStatic',
    'SPCS_ENABLED', 'Speech_Max_Word_Length', 'ISpeechPhraseElement',
    'DISPID_SGRSTransitions', 'DISPID_SRCEPropertyStringChange',
    'SPAR_High', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFTCCITT_ALaw_44kHzMono', 'SPAO_RETAIN_AUDIO',
    'ISpeechRecoResult2', 'SPEI_SR_AUDIO_LEVEL', 'SVP_15',
    'ISpRecoCategory', 'SPAS_RUN', 'DISPID_SRGetPropertyNumber',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SGRsDynamic', 'DISPID_SLPLangId', 'SWTAdded',
    'SpeechAudioProperties', 'DISPID_SVEViseme', 'IStream',
    'DISPID_SGRsFindRule', 'DISPID_SRIsUISupported',
    'SpeechMicTraining', 'SVP_14', 'SVESentenceBoundary',
    'SpPhraseInfoBuilder', 'DISPID_SpeechRecoContextEvents',
    'SITooQuiet', 'DISPID_SPRulesCount', 'SRADynamic',
    'SAFTNonStandardFormat', 'eLEXTYPE_APP', 'DISPID_SWFEBlockAlign',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPPs_NewEnum',
    'DISPID_SLPs_NewEnum', 'DISPID_SRRAlternates', 'ISpEventSource',
    ...
    'SpeechTokenIdUserLexicon', 'SpObjectToken',
    'DISPID_SpeechAudioFormat', 'ISpLexicon',
    'SpeechAudioFormatGUIDText', 'DISPID_SGRsCount',
    'SPPHRASEREPLACEMENT', 'SPEI_END_SR_STREAM', 'SPPS_Verb',
    'DISPID_SLPPartOfSpeech', 'SVSFParseMask',
    'DISPID_SRCCreateGrammar', 'SpeechVoiceCategoryTTSRate',
    'SAFTADPCM_44kHzStereo', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SVIsUISupported', 'DISPID_SPEs_NewEnum', 'SDTProperty',
    'DISPID_SOTCId', 'SpeechTokenKeyUI', 'SPPROPERTYINFO',
    'DISPID_SVSLastBookmarkId', 'SPGS_EXCLUSIVE', 'SP_VISEME_3',
    'SpPhoneConverter', 'SAFT16kHz8BitMono', 'SVSFIsNotXML',
    'SRTReSent', 'SPEI_PHONEME', 'SVSFIsFilename',
    'SPAUDIOBUFFERINFO', 'SDKLCurrentConfig', 'ISpeechAudio',
    'ISpRecognizer3', 'ISpeechMMSysAudio', 'ISpRecoGrammar',
    'SpeechVoiceSpeakFlags', 'SRCS_Enabled', 'SGRSTTWord',
    'DISPID_SOTGetDescription', 'SVSFDefault', 'WAVEFORMATEX',
    'DISPID_SPIElements', 'SRAORetainAudio', 'SVP_6',
    'SAFT12kHz8BitStereo', 'SAFTGSM610_11kHzMono', 'SP_VISEME_19',
    'ISpeechPhoneConverter', 'DISPID_SPRulesItem', 'SITooFast',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRGCmdLoadFromObject',
    '_SPAUDIOSTATE', 'DISPID_SVSInputWordPosition',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPEsItem', 'SPPS_RESERVED4',
    'SpeechPropertyResponseSpeed', 'DISPID_SVEWord',
    'DISPID_SDKCreateKey', 'SPRS_ACTIVE', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SpeechPhraseProperty', 'SAFTDefault', 'SPAUDIOSTATUS',
    'ISpeechRecoResult', 'eLEXTYPE_RESERVED10', 'SRSInactive',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpPhoneticAlphabetSelection',
    'SVP_12', 'SpVoice', 'SVP_13', 'DISPID_SpeechGrammarRules',
    'DISPID_SPRNumberOfElements', 'SDTPronunciation',
    'DISPID_SVSInputWordLength', 'ISpObjectTokenCategory',
    'DISPID_SGRSTPropertyValue', 'SFTSREngine', 'ISpeechRecoContext',
    'DISPID_SABufferInfo', 'DISPID_SPPValue', 'ISpeechLexiconWord',
    'SAFT11kHz16BitStereo', 'SAFT44kHz8BitStereo', 'ISpPhraseAlt',
    'SFTInput', 'DISPIDSPTSI_SelectionOffset', 'SpeechVisemeFeature',
    'DISPID_SVEEnginePrivate', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRGId', 'SPPHRASEELEMENT',
    'SGDisplay', 'eLEXTYPE_PRIVATE1', 'SPGS_DISABLED',
    'SRSActiveAlways', 'SpeechRunState', 'SBOPause', 'SVEViseme',
    'SpeechRecognizerState', 'SAFT11kHz8BitStereo',
    'ISpXMLRecoResult', 'DISPID_SPPNumberOfElements', 'SREStreamEnd',
    'DISPID_SGRAttributes', 'eLEXTYPE_PRIVATE18', 'DISPID_SPAsItem',
    'SPGS_ENABLED', 'SpeechEngineConfidence',
    'SpeechTokenKeyAttributes', 'SRERecognition', 'SpWaveFormatEx',
    'DISPID_SDKEnumValues', 'SP_VISEME_6', 'DISPID_SPRs_NewEnum',
    'SECLowConfidence', 'SAFTCCITT_uLaw_44kHzMono', 'SVF_None',
    'DISPID_SDKOpenKey', 'DISPID_SpeechXMLRecoResult',
    'ISpNotifyTranslator', 'DISPID_SPIRetainedSizeBytes',
    'ISpeechRecognizerStatus', 'DISPID_SGRClear', 'SPEVENTENUM',
    'eLEXTYPE_PRIVATE13', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPEAudioSizeTime', 'SITooSlow', 'SRESoundStart',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPPS_LMA',
    'DISPID_SpeechLexiconWords', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SGRSTRule', 'SP_VISEME_15', 'DISPID_SpeechPhraseBuilder',
    'ISpRecognizer', 'SpeechVisemeType', 'DISPID_SRStatus',
    'SSSPTRelativeToStart', 'DISPID_SpeechObjectTokens', 'DISPIDSPRG',
    'STCInprocServer', 'SPSMF_UPS', 'DISPID_SPPsCount',
    'ISpeechPhraseProperties', 'ISpObjectToken', 'ISpRecoResult',
    'DISPID_SpeechVoice', 'ISpShortcut', 'DISPID_SPAsCount',
    'eLEXTYPE_VENDORLEXICON', 'SGRSTTRule', 'SRARoot',
    'SpeechWordPronounceable', 'SpeechRegistryLocalMachineRoot',
    'eWORDTYPE_DELETED', 'SpeechPropertyResourceUsage',
    'SPEI_RESERVED6', 'DISPID_SWFEAvgBytesPerSec', 'SP_VISEME_13',
    'SSFMCreateForWrite', 'eLEXTYPE_PRIVATE7', 'SP_VISEME_10',
    'SPEVENT', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRGDictationSetState', 'SREAllEvents',
    'SAFT24kHz16BitStereo', 'Speech_Default_Weight',
    'Speech_Max_Pron_Length', 'SPCT_SLEEP', 'SPPHRASE',
    'SGDSActiveWithAutoPause', 'SP_VISEME_11', 'SPSUnknown',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPRuleFirstElement',
    'DISPID_SVResume', 'DISPID_SVAudioOutputStream', 'SPSHT_OTHER',
    'DISPID_SPPsItem', 'DISPID_SPEPronunciation',
    'ISpObjectWithToken', 'DISPID_SOTSetId',
    'SAFTTrueSpeech_8kHz1BitMono', 'SRERequestUI', 'ISpProperties',
    'DISPID_SOTId', 'SPBO_PAUSE', 'DISPID_SRCEAdaptation', 'SPSVerb',
    'DISPID_SpeechLexicon', 'DISPID_SpeechGrammarRule',
    'DISPID_SpeechLexiconWord', 'DISPID_SPPBRestorePhraseFromMemory',
    'SVP_18', 'DISPID_SAFType', 'DISPID_SRCVoice', 'DISPID_SRGState',
    'SPWT_LEXICAL', 'DISPID_SPISaveToMemory', 'SVEEndInputStream',
    'DISPID_SFSOpen', 'SLTUser', 'SVSFParseSsml',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SBSFormat',
    'SVEVoiceChange', 'SpAudioFormat', 'IInternetSecurityManager',
    'DISPID_SDKSetStringValue', 'DISPID_SOTCEnumerateTokens',
    'tagSPTEXTSELECTIONINFO', 'ISpeechRecognizer',
    'SRTExtendableParse', 'SPEI_RESERVED1', 'SVSFlagsAsync',
    'ISpeechXMLRecoResult', 'SVEAudioLevel',
    'DISPID_SRGDictationLoad', 'DISPID_SpeechBaseStream', 'SPBO_NONE',
    'ISpeechPhraseInfoBuilder', 'SpeechCategoryRecognizers',
    'ISpeechPhraseRules', 'SPGRAMMARWORDTYPE', 'eLEXTYPE_RESERVED6',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SP_VISEME_21',
    'SPEI_SOUND_START', 'SPDKL_CurrentConfig', 'ISpGrammarBuilder',
    'SVF_Stressed', 'ISpRecoContext2', 'SPRULE',
    'DISPID_SRRTTickCount', 'ISpeechGrammarRuleStateTransition',
    'SWTDeleted', 'DISPID_SMSAMMHandle', 'SpInprocRecognizer',
    'DISPID_SRRTStreamTime', 'ISpPhoneticAlphabetConverter',
    'SAFT12kHz16BitMono', 'DISPID_SLAddPronunciationByPhoneIds',
    'Speech_StreamPos_Asap', 'SpMemoryStream', 'DISPID_SLWsItem',
    'SAFTGSM610_8kHzMono', 'SRSEIsSpeaking', 'SAFTADPCM_22kHzStereo',
    'DISPID_SBSSeek', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRSAudioStatus', 'DISPID_SRCEInterference',
    'SAFT48kHz8BitMono', 'DISPID_SRCEAudioLevel', 'SPRULESTATE',
    ...
    'DISPID_SRRGetXMLResult', 'SPEI_VISEME', 'DISPID_SBSRead',
    'DISPID_SVSLastBookmark', 'SPEI_REQUEST_UI',
    'SpeechStreamFileMode', 'SPSHORTCUTPAIR',
    'SpeechSpecialTransitionType', 'DISPID_SVEPhoneme',
    'SAFT22kHz8BitStereo', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVGetAudioOutputs', 'DISPID_SDKSetBinaryValue',
    'SPEI_TTS_BOOKMARK', 'eLEXTYPE_PRIVATE5',
    'SWPKnownWordPronounceable', 'ISpeechObjectTokenCategory',
    'DISPID_SPRsItem', 'DISPID_SMSADeviceId', 'SPSLMA',
    'DISPID_SRGIsPronounceable', 'DISPID_SGRSTWeight',
    'SpeechAudioState', 'tagSPPROPERTYINFO',
    'DISPID_SOTCreateInstance', 'SPEI_RECO_STATE_CHANGE',
    'SpeechAudioVolume', 'DISPID_SMSSetData', 'ISpeechGrammarRule',
    'SDKLCurrentUser', 'SVP_0', 'SPWORDPRONUNCIATIONLIST', 'SASRun',
    'SRAInterpreter', 'SpeechDisplayAttributes',
    'SPRECOCONTEXTSTATUS', 'SREAudioLevel', 'DISPID_SPEDisplayText',
    'SSFMOpenForRead', 'SPSNoun', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRGRules', 'ISpeechLexicon', 'SDTAlternates',
    'SPPARTOFSPEECH', 'SGSEnabled', 'SpStream',
    'SpeechCategoryRecoProfiles', 'SpeechAddRemoveWord',
    'SPEI_START_INPUT_STREAM', 'SVP_11',
    'SpeechDictationTopicSpelling', 'DISPID_SGRSRule',
    'ISpeechPhraseAlternates', 'SPSHORTCUTPAIRLIST', 'SPPHRASERULE',
    'SPWF_SRENGINE', 'SpInProcRecoContext', 'DISPID_SOTCDefault',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_8',
    'DISPID_SpeechObjectTokenCategory', 'SAFT16kHz16BitMono',
    'SPBO_AHEAD', 'ISpeechBaseStream', 'SpeechCategoryAudioOut',
    ...
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPRuleName',
    'ISpeechPhraseElements', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechPhraseElements', 'SAFTCCITT_uLaw_11kHzMono',
    'SPEI_PHRASE_START', 'SpeechPropertyComplexResponseSpeed',
    'SPVPRI_OVER', 'SPINTERFERENCE_NONE', 'LONG_PTR',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SRTAutopause',
    'DISPID_SGRsCommitAndSave', 'IEnumString', 'ISpNotifySink',
    'ISpeechObjectTokens', 'SPAS_CLOSED', 'SPLEXICONTYPE',
    'DISPID_SPAPhraseInfo', 'SAFT8kHz16BitStereo',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechObjectToken',
    'SPINTERFERENCE_NOISE', 'DISPID_SPCLangId', 'SRTEmulated',
    'DISPID_SPAs_NewEnum', '_ISpeechRecoContextEvents',
    'DISPID_SPPId', 'SP_VISEME_2', 'UINT_PTR', 'SPEI_RESERVED3',
    'DISPID_SLGetWords', 'SpeechStreamSeekPositionType',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpeechPhraseRule', 'SVPAlert',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTADPCM_22kHzMono',
    'DISPID_SVSkip', 'ISpeechVoiceStatus', 'DISPID_SRGCommit',
    'DISPID_SBSWrite', 'SPSHT_Unknown', 'SPEI_MAX_TTS',
    'ISpEventSink', 'SPGRAMMARSTATE',
    'DISPID_SpeechLexiconPronunciation', 'STCLocalServer',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SECFIgnoreWidth',
    ...
    'DISPID_SWFEExtraData', 'SpeechAllElements',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SRAImport',
    'DISPID_SPIGrammarId', 'ISpeechPhraseInfo',
    'SpeechDataKeyLocation', 'SECFNoSpecialChars',
    'SpStreamFormatConverter', 'ISpeechGrammarRuleStateTransitions',
    'SPEI_VOICE_CHANGE', 'SPCT_SUB_COMMAND',
    ...
    'SSFMOpenReadWrite', 'SpeechVoiceEvents',
    'DISPID_SRSCurrentStreamPosition', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPLO_STATIC', 'SPRST_ACTIVE_ALWAYS', 'SPRST_NUM_STATES',
    'SAFT48kHz8BitStereo', 'DISPID_SLWsCount', 'DISPID_SGRsAdd',
    'SPEI_ADAPTATION', 'SpeechTokenValueCLSID', 'DISPID_SOTDataKey',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPIEngineId',
    'SPSNotOverriden', 'STSF_AppData', 'DISPID_SPRuleConfidence',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRRTLength',
    'DISPID_SPIGetDisplayAttributes', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPIProperties', 'SREStateChange',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechPhraseProperties',
    'DISPIDSPTSI', 'DISPID_SpeechPhoneConverter', 'SPWORDTYPE',
    'SPSHT_EMAIL', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpRecognizer2', 'SAFT11kHz8BitMono', 'DISPID_SRGetRecognizers',
    'SRAONone', 'SECFIgnoreCase', 'eLEXTYPE_PRIVATE19',
    'DISPID_SMSGetData', 'DISPID_SVStatus', 'SPSFunction',
    'DISPID_SLWWord', 'SAFT44kHz16BitStereo', 'eLEXTYPE_RESERVED9',
    'SAFTText', 'DISPID_SpeechAudio', 'SPEI_MIN_SR',
    'DISPID_SpeechFileStream', 'SRTSMLTimeout', 'STCAll',
    'SpFileStream', 'SPVOICESTATUS', 'SAFT11kHz16BitMono',
    'SpeechVoiceSkipTypeSentence', 'SPCONTEXTSTATE',
    'SAFTADPCM_8kHzMono', 'DISPID_SVSpeak', 'DISPID_SASState',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRGDictationUnload', 'SP_VISEME_5', 'DISPID_SFSClose',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRCEPropertyNumberChange', 'SPWORD', 'DISPID_SGRName',
    'DISPID_SGRInitialState', 'eLEXTYPE_PRIVATE8',
    'DISPID_SAEventHandle', 'SpeechRecoProfileProperties',
    'DISPID_SGRSTsItem', 'DISPID_SPPParent', 'SSFMCreate',
    'eLEXTYPE_PRIVATE16', 'SPAUDIOSTATE', 'SP_VISEME_17',
    'DISPID_SpeechVoiceStatus', 'DISPID_SVGetVoices',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPIStartTime',
    'SpeechTokenShellFolder', 'eLEXTYPE_LETTERTOSOUND',
    'SRCS_Disabled', 'SPVPRI_NORMAL', 'SVP_9', 'DISPID_SLWType',
    ...
    'SPSHT_NotOverriden', 'DISPID_SVEStreamEnd', 'SPSEMANTICFORMAT',
    'SPCS_DISABLED', 'DISPID_SLPsCount', 'SVSFUnusedFlags',
    'SWPUnknownWordUnpronounceable', 'SREInterference',
    'SpeechGrammarTagDictation', 'ISpeechTextSelectionInformation',
    'SpPhoneticAlphabetConverter', 'SPWF_INPUT', 'SP_VISEME_4',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRRDiscardResultInfo',
    'SPAR_Medium', 'SAFTNoAssignedFormat', 'SRTStandard',
    'SPWT_DISPLAY', 'DISPID_SGRSTPropertyId', 'SPAS_STOP',
    'eLEXTYPE_PRIVATE17', 'DISPID_SRRSetTextFeedback',
    'ISpeechRecoResultTimes', 'SAFT22kHz8BitMono', 'SSTTWildcard',
    'SpeechPropertyAdaptationOn', 'SPSERIALIZEDPHRASE',
    'SpeechWordType', 'DISPID_SLPSymbolic', 'SGLexical', 'SRAExport',
    ...
    'DISPID_SLGetGenerationChange', 'SSTTTextBuffer',
    'SAFT32kHz8BitMono', 'SPEVENTSOURCEINFO', 'SpResourceManager',
    'SDA_Consume_Leading_Spaces', 'SAFTCCITT_uLaw_8kHzStereo',
    'SVSFIsXML', 'SPEI_END_INPUT_STREAM', 'SREPropertyNumChange',
    'SPCT_DICTATION', 'IEnumSpObjectTokens', 'SPCATEGORYTYPE',
    'SVPOver', 'DISPID_SPCIdToPhone', 'DISPID_SVVoice', 'SASPause',
    'SLTApp', 'DISPID_SVEVoiceChange', 'SpeechLoadOption',
    'DISPID_SVGetAudioInputs', 'SpeechCategoryPhoneConverters',
    'SP_VISEME_7', 'SPEI_RESERVED2', 'DISPID_SPEsCount',
    'SAFTCCITT_ALaw_8kHzMono', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechPropertyHighConfidenceThreshold', 'SAFTADPCM_11kHzMono',
    'SGSDisabled', 'eLEXTYPE_PRIVATE6', 'DISPID_SPIGetText',
    'SREPropertyStringChange', 'DISPID_SVSpeakCompleteEvent',
    'SpShortcut', 'SVP_5', 'SpeechRuleState', 'DISPID_SASetState',
    'eLEXTYPE_PRIVATE2', 'SpeechRecognitionType',
    ...
    'SPEI_SOUND_END', 'DISPID_SPERequiredConfidence',
    'DISPID_SLAddPronunciation', 'SPEI_TTS_PRIVATE',
    'DISPID_SPIReplacements', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPILanguageId', 'DISPID_SPRuleEngineConfidence',
    'SPPS_RESERVED1', 'SPSModifier', 'SVEPhoneme',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPIRule', 'SPEI_WORD_BOUNDARY',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'eLEXTYPE_USER', 'ISpRecoContext',
    ...
    'SPXRO_Alternates_SML', 'ISpeechResourceLoader',
    'DISPID_SRRSaveToMemory', 'SPWT_PRONUNCIATION',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SAFGetWaveFormatEx', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpLexicon', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SVEStreamStart', 'SPXMLRESULTOPTIONS',
    'DISPID_SVEventInterests', 'ISpeechPhraseProperty',
    'SGLexicalNoSpecialChars', 'DISPID_SVEAudioLevel',
    'DISPID_SLPsItem', 'SDKLLocalMachine', 'SAFTExtendedAudioFormat',
    'SRATopLevel', 'SAFT44kHz16BitMono', 'DISPID_SVEBookmark',
    'DISPID_SRRTimes', 'SPSHORTCUTTYPE', 'SVP_19',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPPName',
    'SpeechInterference', 'DISPID_SLGenerationId',
    'SpeechCategoryVoices', 'DISPID_SRGetFormat', 'DISPID_SAVolume',
    'SAFT48kHz16BitMono', 'SPEI_MIN_TTS', 'SpeechAudioFormatGUIDWave',
    'DISPID_SLRemovePronunciation', 'SECFDefault',
    'DISPID_SMSALineId', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SDKEnumKeys', 'SAFT8kHz8BitMono', 'SPFM_CREATE_ALWAYS',
    'ISpVoice', 'SPPS_Function', 'DISPID_SOTsItem',
    'Speech_StreamPos_RealTime', 'SPPS_Modifier',
    'ISpStreamFormatConverter', 'DISPID_SRGetPropertyString',
    'DISPID_SRCState', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPRText', 'DISPID_SRDisplayUI', 'SpNullPhoneConverter',
    'DISPID_SLWs_NewEnum', 'SAFT32kHz16BitMono', 'SPAO_NONE',
    'SpeechGrammarTagWildcard', 'SPEI_SR_PRIVATE',
    'DISPID_SpeechPhraseAlternate', 'SPPHRASEPROPERTY',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVP_20',
    'DISPID_SVPause', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPPChildren', 'eLEXTYPE_RESERVED4',
    'SpeechRuleAttributes', 'DISPID_SASFreeBufferSpace',
    'SpeechLexiconType', 'SpUnCompressedLexicon',
    'DISPID_SRSClsidEngine', 'ISpeechGrammarRules', 'SVSFNLPMask',
    'SpeechPartOfSpeech', 'ISpeechAudioBufferInfo',
    'DISPID_SRSetPropertyString', 'DISPID_SGRsItem',
    'ISpRecoGrammar2', 'DISPID_SRCEBookmark',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTCGetDataKey',
    'SpMMAudioIn', 'SPBO_TIME_UNITS', 'eLEXTYPE_PRIVATE4',
    ...
    'DISPID_SLWPronunciations', 'ISpeechPhraseAlternate',
    'DISPID_SRCSetAdaptationData', 'DISPID_SOTDisplayUI',
    'SAFT16kHz8BitStereo', 'DISPID_SRRPhraseInfo', 'ISpStream',
    'SREPhraseStart', 'SAFT16kHz16BitStereo', 'SpeechGrammarState',
    'DISPID_SRCBookmark', 'DISPID_SOTCategory', 'SVEStartInputStream',
    'SVSFPersistXML', 'DISPID_SRGRecoContext',
    'DISPID_SOTIsUISupported', 'SPSERIALIZEDRESULT', 'DISPID_SVRate',
    'DISPID_SRAudioInputStream', 'SDTRule', 'SPEI_TTS_AUDIO_LEVEL',
    'STSF_FlagCreate', 'SINoSignal', 'DISPID_SWFEBitsPerSample',
    'DISPID_SVAlertBoundary', 'DISPID_SRState', 'SPEI_MAX_SR',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVF_Emphasis',
    'DISPID_SRRecognizer', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SLWLangId', 'SPPS_RESERVED3', 'SVP_7', 'SPSInterjection',
    'DISPID_SVPriority', 'SPEI_SR_BOOKMARK', 'SVP_4', 'SGSExclusive',
    'DISPID_SWFEFormatTag', 'DISPID_SRGCmdSetRuleState',
    ...
    'DISPID_SDKDeleteValue', 'SGRSTTEpsilon', 'SVSFParseSapi',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechPhraseRule',
    'SPFM_NUM_MODES', 'DISPID_SOTs_NewEnum', 'SpeechFormatType',
    'SVEBookmark', 'DISPID_SPPEngineConfidence', 'DISPID_SOTCSetId',
    'SVP_17', 'SSSPTRelativeToEnd',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPAUDIOOPTIONS',
    'SP_VISEME_14', 'ISpSerializeState', 'DISPID_SpeechAudioStatus',
    'ISpeechPhraseReplacements', 'SPTEXTSELECTIONINFO',
    'SDTLexicalForm', 'SAFT44kHz8BitMono', 'DISPID_SRRAudio',
    'SP_VISEME_8', 'ISpMMSysAudio', 'SAFTADPCM_11kHzStereo',
    'SpeechTokenKeyFiles', 'SREAdaptation', 'DISPID_SGRId',
    'DISPID_SOTMatchesAttributes', 'DISPID_SDKDeleteKey',
    'SpSharedRecoContext', 'DISPID_SRCreateRecoContext',
    'SPRS_INACTIVE', 'SAFTADPCM_44kHzMono',
    'DISPID_SPIAudioStreamPosition', 'SAFT24kHz8BitMono',
    'ISpeechGrammarRuleState', 'SP_VISEME_1', 'SGRSTTDictation',
    'SVP_16', 'ISpStreamFormat', 'SPDKL_LocalMachine',
    'SPFM_OPEN_READWRITE', 'DISPID_SRCPause', 'SP_VISEME_0',
    'DISPID_SpeechPhraseElement', 'SDTReplacement',
    'DISPID_SRCRequestedUIType', 'SPPS_RESERVED2',
    'SpeechUserTraining', 'STCRemoteServer', 'SpNotifyTranslator',
    'DISPID_SOTsCount', 'SpeechDiscardType', 'DISPID_SVGetProfiles',
    'SpeechCategoryAudioIn', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SpeechRecoResult', 'SPEI_HYPOTHESIS', 'SGDSInactive',
    'DISPID_SDKGetlongValue', 'SDTAll',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SpeechPhraseInfo',
    'SPWAVEFORMATTYPE', 'SASStop', 'DISPID_SOTGetAttribute',
    'SSTTDictation', 'ISpeechAudioStatus', 'SPINTERFERENCE_TOOFAST',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SDA_No_Trailing_Space',
    'eLEXTYPE_PRIVATE20', 'SINone', 'SPRST_INACTIVE_WITH_PURGE',
    'SDA_Two_Trailing_Spaces', 'DISPID_SGRSAddWordTransition',
    'SPEI_START_SR_STREAM', 'SPVPRI_ALERT',
    'DISPID_SpeechPhraseRules', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPPConfidence', 'SVP_3',
    'DISPID_SREmulateRecognition', 'SAFTGSM610_44kHzMono',
    'SPWORDPRONUNCIATION', 'SECFEmulateResult',
    'SWPUnknownWordPronounceable', 'DISPID_SRGSetWordSequenceData',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SABIEventBias', 'SDTAudio',
    'SPSMF_SAPI_PROPERTIES', 'eLEXTYPE_PRIVATE9', 'SPPS_Noun',
    'DISPID_SGRAddState', 'DISPID_SOTGetStorageFileName',
    'SECFIgnoreKanaType', 'STCInprocHandler', 'SPXRO_SML',
    'SPEI_PROPERTY_NUM_CHANGE', 'SRADefaultToActive',
    'SPEI_RECOGNITION', 'SRESoundEnd', 'DISPID_SpeechMMSysAudio',
    'eLEXTYPE_PRIVATE12', 'SPPS_SuppressWord',
    'DISPID_SPRDisplayAttributes', 'SAFT8kHz8BitStereo',
    'DISPID_SVAudioOutput', 'DISPIDSPTSI_ActiveOffset', 'SPRECOSTATE',
    'DISPID_SPRuleId', 'DISPID_SDKGetStringValue',
    'SAFT22kHz16BitMono', 'ISpeechLexiconWords', 'ISpPhrase', 'SVP_2',
    'SpMMAudioEnum', 'SAFT8kHz16BitMono', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCResume', 'SPRST_ACTIVE', 'SPVPRIORITY',
    'ISpeechAudioFormat', 'eLEXTYPE_PRIVATE3',
    '__MIDL_IWinTypes_0009', 'SpeechRecoEvents', 'DISPID_SRProfile',
    'SDKLDefaultLocation', 'SPEI_UNDEFINED', 'SREBookmark',
    'DISPID_SVDisplayUI', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SGRSTTWildcard', 'SPEI_INTERFERENCE', 'DISPID_SRCERecognition',
    'SPRECOGNIZERSTATUS', 'SpMMAudioOut', 'DISPID_SRCEEndStream',
    'DISPID_SGRsCommit', 'DISPID_SRRRecoContext',
    'DISPID_SPIAudioSizeTime', 'eLEXTYPE_RESERVED7',
    'DISPID_SWFEChannels', 'SP_VISEME_16', 'SpeechAudioFormatType',
    'DISPID_SAStatus', 'SAFT24kHz8BitStereo', 'SpeechVoicePriority',
    'DISPID_SRCEPhraseStart', 'SPRST_INACTIVE',
    'DISPID_SpeechLexiconProns', 'SPSSuppressWord', 'SPPS_Noncontent',
    'DISPID_SpeechPhraseReplacements', 'SVP_21', 'SPRECORESULTTIMES',
    'SpSharedRecognizer', 'SPBINARYGRAMMAR', 'SAFT24kHz16BitMono',
    'SpeechRecoContextState', 'DISPID_SRRSpeakAudio',
    'SpCustomStream', 'ISpeechRecoGrammar',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SASNonBlockingIO',
    'DISPID_SDKSetLongValue', 'SAFTCCITT_uLaw_8kHzMono', 'SITooLoud',
    'DISPID_SpeechMemoryStream',
    'SpeechGrammarRuleStateTransitionType', 'SPSTREAMFORMATTYPE',
    '_ISpeechVoiceEvents', 'SP_VISEME_18', 'DISPID_SPRuleChildren',
    'SpeechTokenContext', 'SAFT12kHz16BitStereo',
    'DISPID_SRCRetainedAudio', 'ISpResourceManager', 'SPLOADOPTIONS',
    'DISPID_SLPType', 'ISpeechPhraseReplacement', 'SPCT_COMMAND',
    'SGDSActive', 'DISPID_SPRsCount', 'DISPID_SGRAddResource',
    'SpeechEmulationCompareFlags', 'SRSActive',
    'SAFT22kHz16BitStereo', 'SPDKL_CurrentUser', 'STSF_LocalAppData',
    ...
    'SpeechEngineProperties', 'DISPID_SRGReset', 'SVP_10',
    'DISPID_SpeechDataKey', 'SP_VISEME_9', 'SRSEDone', 'SVEAllEvents',
    'DISPID_SpeechVoiceEvent', 'SINoise', 'SPPS_Interjection',
    'SPEI_RESERVED5', 'ISpPhoneConverter',
    'DISPID_SOTRemoveStorageFileName', 'SVPNormal', 'ISpAudio',
    'DISPID_SGRSTText', 'SPWORDLIST', 'SPPS_NotOverriden',
    'SREHypothesis', 'DISPID_SRCEHypothesis', 'ISpeechObjectToken',
    'SBONone', 'DISPID_SVSPhonemeId', 'SAFT48kHz16BitStereo',
    'DISPID_SVSRunningState', 'DISPID_SRCESoundStart',
    'SAFTADPCM_8kHzStereo', 'DISPID_SGRSAddSpecialTransition',
    'ISequentialStream', 'SPFM_OPEN_READONLY', 'SP_VISEME_12',
    'STSF_CommonAppData', 'SP_VISEME_20', 'DISPID_SVSpeakStream',
    'DISPID_SRCCmdMaxAlternates', 'SGPronounciation',
    'DISPID_SCSBaseStream', 'ISpeechLexiconPronunciations',
    'DISPID_SAFGuid', 'DISPID_SGRs_NewEnum', 'SRSInactiveWithPurge',
    'SPBOOKMARKOPTIONS', 'ISpeechCustomStream', 'eLEXTYPE_RESERVED8',
    'DISPID_SPANumberOfElementsInResult', 'SVSFNLPSpeakPunc',
    'SPINTERFERENCE', 'SAFT12kHz8BitMono', 'DISPID_SRCEStartStream',
    'DISPID_SABIMinNotification', 'ISpeechMemoryStream', 'SLODynamic',
    'SGDSActiveUserDelimited', 'DISPID_SADefaultFormat',
    'DISPID_SVVolume', 'DISPID_SPACommit',
    'DISPID_SPERetainedStreamOffset', 'SDTDisplayText',
    'DISPID_SpeechRecoResult2', 'DISPID_SRIsShared', 'SPPS_Unknown',
    'DISPID_SPCPhoneToId'
]
